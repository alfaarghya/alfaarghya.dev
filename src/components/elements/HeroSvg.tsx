  ...
  return (
    <div className="relative w-full">
      ...
      <motion.svg //javascript
        ...
        initial="initial"
        animate="animate"
        className=" lg:block lg:size-12 size-10 absolute lg:bottom-12 lg:right-0  rotate-12 drop-shadow-[0_16px_24px_rgba(247,147,20,0.35)"
        xmlns="http://www.w3.org/2000/svg"
      ...
      <motion.svg //react
        ...
        initial="initial"
        animate="animate"
        className=" lg:block lg:size-14 size-10 absolute lg:top-72 -top-5 lg:-right-24 right-24 rotate-12 drop-shadow-[0_16px_24px_rgba(0,0,255,0.35)"
        fill="none"
        viewBox="0, 0, 32, 32"
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <div className="blur-[2px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute top-[250px] right-32 rotate-90 "
          fill="#ffffff"
          viewBox="0 0 32 32"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[1px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute top-24 -right-48 rotate-12 "
          fill="#ffffff"
          viewBox="0 0 32 32"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[1px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute bottom-28 left-20  rotate-12 "
          fill="#none"
          viewBox="0 0 32 32"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[2px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute -top-3 left-24 rotate-12 "
          fill="#ffffff"
          viewBox="0 0 32 32"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[2px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute top-4 right-20 rotate-12 "
          fill="#ffffff"
          viewBox="0 0 32 32"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[3px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute bottom-32 left-80 rotate-12 "
          fill="#ffffff"
          viewBox="0 0 32 32"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[1px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute -top-20 left-56 rotate-12 "
          fill="none"
          viewBox="0 0 32 32"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[3px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute top-36 -left-52 rotate-12 "
      ...
      <div className="blur-[1px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute top-[440px] right-24 rotate-12 "
          viewBox="0 0 32 32"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[1px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute top-[370px] left-48 rotate-12 "
          viewBox="0 0 32 32"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[2px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className="hidden lg:block lg:size-14 size-10 absolute top-52   rotate-12 "
          viewBox="0 0 32 32"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="blur-[3px]">
        <motion.svg
          ...
          initial="initial"
          animate="animate"
          className=" hidden lg:block lg:size-14 size-10 absolute top-[460px] left-8 rotate-12 "
          viewBox="0 0 256 256"
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
